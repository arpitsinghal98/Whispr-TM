...
export default function MeetingSummary({ summary, actionItems, insights }: MeetingSummaryProps) {
  return (
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <div className="flex flex-wrap gap-2">
                {insights.keyTopics.map((topic, index) => (
                  <span key={index} className="px-3 py-1 bg-[#4B3576]/10 text-[#4B3576] rounded-full text-sm">
                    {topic}
                  </span>
                ))}
              </div>
